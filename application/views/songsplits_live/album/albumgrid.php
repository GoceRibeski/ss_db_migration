<?
   ...
   $modify_url = site_url('album/modify/');
   $delete_url = site_url('album/delete/');
   $add_url    = site_url('album/add/');
...
<form action='<?= $add_url; ?>' method='POST' id='frmalbum'>
<table width="100%" border="0" cellspacing="1" cellpadding="0">
<tr>
   <th align="left" class="formSecHeader">Browsing album values</th>
   <th align="right">
...
<tbody  class="scrollingContent">
      ...
      <tr bgcolor="<?= $bgColor; ?>">
         <td align="center" nowrap="nowrap">
            <a href = "<?= $modify_url."/".$album["album_id"]; ?>" >Edit</a>
            &nbsp;&nbsp;&nbsp;
            <a href = "<?= $delete_url."/".$album["album_id"]; ?>" >Delete</a>
         </td>
   <td align="left" nowrap="nowrap"><?= $album['album_id']; ?></td>
   <td align="left" nowrap="nowrap"><?= $album['temp_id']; ?></td>
   <td align="left" nowrap="nowrap"><?= $album['artist_id']; ?></td>
   <td align="left" nowrap="nowrap"><?= $album['release']; ?></td>
   <td align="left" nowrap="nowrap"><?= $album['artist']; ?></td>
   <td align="left" nowrap="nowrap"><?= $album['label']; ?></td>
</tr>
      <? } ?>
</tbody>
</table>
