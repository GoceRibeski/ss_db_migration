...
//   }
   ...
   function find($filters = NULL, $start = NULL, $count = NULL) {
      ...
      // ///////////////////////////////////////////////////////////////////////
      $this->table_record_count = $this->db_songsplits_api->count_all( 'request' );
      ...
      $query = $this->db_songsplits_api->get( 'request' );
   ...
   function add( $data ) {
      ...
      $this->db_songsplits_api->insert('request', $data);
   ...
   function modify($keyvalue, $data) {
      ...
      $this->db_songsplits_api->update('request', $data);
   ...
   function delete_by_pkey($idField) {
      ...
      // ///////////////////////////////////////////////////////////////////////
      // $this->db_songsplits_api->where('id', $idField);
      // $this->db_songsplits_api->delete('request');
