...
class Referral extends CI_Controller {
   ...
   */
   ...
   function browse() {
      ...
      $this->load->model('songsplits_api_new/referralmodel');                  // Instantiate the model
      ...
      $this->layout->render_page('/songsplits_api_new/referral/referralgrid', $the_results);
      // NOTE: If you don't want to use the layout library, use the line below.
      // $this->load->view('/songsplits_api_new/referral/referralgrid', $the_results);
   ...
   function add() {
      ...
      if ( $submit != false ) {
         ...
         // ////////////////////////////////////////////////////////////////////
         $this->load->model('songsplits_api_new/referralmodel');
         ...
         */
         ...
         // $this->load->helper('url');
         redirect('/songsplits_api_new/referral/', 'location');
         ...
         */
         ...
         $this->load->library('songsplits_api_new/layout');
         $this->layout->render_page('/songsplits_api_new/referral/referraldetails', $data);
         // NOTE: If you don't want to use the layout library, use the line below.
         // $this->load->view('/songsplits_api_new/referral/referraldetails', $data);
