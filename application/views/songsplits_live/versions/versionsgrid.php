<?
   ...
   $modify_url = site_url('versions/modify/');
   $delete_url = site_url('versions/delete/');
   $add_url    = site_url('versions/add/');
...
<form action='<?= $add_url; ?>' method='POST' id='frmversions'>
<table width="100%" border="0" cellspacing="1" cellpadding="0">
<tr>
   <th align="left" class="formSecHeader">Browsing versions values</th>
   <th align="right">
...
<tbody  class="scrollingContent">
      ...
      <?
         $i = 0;
         foreach ($versions_list as $versions) {
            $i++;
            if (($i%2)==0) { $bgColor = "#FFFFFF"; } else { $bgColor = "#C0C0C0"; }
      ?>
      <tr bgcolor="<?= $bgColor; ?>">
         <td align="center" nowrap="nowrap">
            <a href = "<?= $modify_url."/".$versions["version_id"]; ?>" >Edit</a>
            &nbsp;&nbsp;&nbsp;
            <a href = "<?= $delete_url."/".$versions["version_id"]; ?>" >Delete</a>
         </td>
   <td align="left" nowrap="nowrap"><?= $versions['version_id']; ?></td>
   <td align="left" nowrap="nowrap"><?= $versions['song_id']; ?></td>
   <td align="left" nowrap="nowrap"><?= $versions['writer_id']; ?></td>
   <td align="left" nowrap="nowrap"><?= $versions['version']; ?></td>
   <td align="left" nowrap="nowrap"><?= $versions['additional_info']; ?></td>
   <td align="left" nowrap="nowrap"><?= $versions['old_song_title']; ?></td>
   <td align="left" nowrap="nowrap"><?= $versions['date_added']; ?></td>
</tr>
      <? } ?>
</tbody>
</table>
