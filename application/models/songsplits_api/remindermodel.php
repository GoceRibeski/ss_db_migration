...
//   }
   ...
   function find($filters = NULL, $start = NULL, $count = NULL) {
      ...
      // ///////////////////////////////////////////////////////////////////////
      $this->table_record_count = $this->db_songsplits_api->count_all( 'reminder' );
      ...
      $query = $this->db_songsplits_api->get( 'reminder' );
   ...
   function retrieve_by_pkey($idField) {
      ...
      $this->db_songsplits_api->where( 'reminder_id', "$idField");
   ...
   function add( $data ) {
      ...
      $this->db_songsplits_api->insert('reminder', $data);
   ...
   function modify($keyvalue, $data) {
      ...
      $this->db_songsplits_api->where('reminder_id', $keyvalue);
      $this->db_songsplits_api->update('reminder', $data);
   ...
   function delete_by_pkey($idField) {
      ...
      // ///////////////////////////////////////////////////////////////////////
      // $this->db_songsplits_api->where('reminder_id', $idField);
      // $this->db_songsplits_api->delete('reminder');
