...
/**
 * MODULE NAME   : othermodel.php
 *
 * DESCRIPTION   : Other model controller
 *
 * MODIFICATION HISTORY
 *   V1.0   2016-06-20 10:59 AM   - Pradesh Chanderpaul     - Created
 *
 * @package             other
 * @subpackage          Other model component Class
...
//      return $this->find(array('other_id' => '$key_value'));
//   }
   ...
   function find($filters = NULL, $start = NULL, $count = NULL) {
      ...
      // ///////////////////////////////////////////////////////////////////////
      $this->table_record_count = $this->db_songsplits_api_new->count_all( 'other' );
      ...
      $query = $this->db_songsplits_api_new->get( 'other' );
   ...
   function retrieve_by_pkey($idField) {
      ...
      $this->db_songsplits_api_new->where( 'other_id', "$idField");
   ...
   function add( $data ) {
      ...
      $this->db_songsplits_api_new->insert('other', $data);
   ...
   function modify($keyvalue, $data) {
      ...
      $this->db_songsplits_api_new->where('other_id', $keyvalue);
      $this->db_songsplits_api_new->update('other', $data);
   ...
   function delete_by_pkey($idField) {
      ...
      // ///////////////////////////////////////////////////////////////////////
      // $this->db_songsplits_api_new->where('other_id', $idField);
      // $this->db_songsplits_api_new->delete('other');
