 ...
 * MODULE NAME   : Img.php
 *
 * DESCRIPTION   : Img module controller
 *
 * MODIFICATION HISTORY
 *   V1.0   2016-06-16 05:24 PM   - Pradesh Chanderpaul     - Created
 *
 * @package             Img
 * @subpackage          img component Class
...
class Img extends CI_Controller {
   ...
   */
   ...
   // Function: showall()
   //
   // Description: Extracts a list of all img data records and displays it.
   //
   // //////////////////////////////////////////////////////////////////////////
   function browse() {
      ...
      // ...the img model and sending it a 'retrievelist' request.
      // ///////////////////////////////////////////////////////////////////////
      ...
      $this->load->model('songsplits_live/imgmodel');                  // Instantiate the model
      $the_results['img_list'] = $this->imgmodel->findAll($start, $limit_per_page);  // Send the retrievelist msg
      // $the_results['rowcount'] = count($the_results['img_list']);
      ...
      $config['base_url']     = site_url('img/showall/');   // or just /img/
      $config['total_rows']   = $this->imgmodel->table_record_count;
      ...
      $this->layout->render_page('/songsplits_live/img/imggrid', $the_results);
      // NOTE: If you don't want to use the layout library, use the line below.
      // $this->load->view('songsplits_live/img/imggrid', $the_results);
   ...
   // Function: add()
   //
   // Description: Prompts user for input and adds a new img entry
   //              ...onto the database.
   //
   // //////////////////////////////////////////////////////////////////////////
   function add() {
      ...
      if ( $submit != false ) {
         ...
         */
         ...
         $this->imgmodel->add($data);

         // $this->load->helper('url');
         redirect('/songsplits_live/img/', 'location');
         ...
         */
         ...
         $this->load->library('songsplits_live/layout');
         $this->layout->render_page('/songsplits_live/img/imgdetails', $data);
         // NOTE: If you don't want to use the layout library, use the line below.
         // $this->load->view('songsplits_live/img/imgdetails', $data);
   ...
   function modify() {
      ...
      if ( $submit != false ) {
         ...
         */
         ...
         $this->imgmodel->modify($data['img_id'], $data);
         ...
         $this->load->model('songsplits_live/imgmodel');
         $data = $this->imgmodel->retrieve_by_pkey($idField);
         $data['action'] = 'modify';
   ...
   function delete() {
      ...
      $this->load->model('songsplits_live/imgmodel');
      $the_results = $this->imgmodel->delete_by_pkey($idField);
