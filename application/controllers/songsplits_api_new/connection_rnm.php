...
class Connection_rnm extends CI_Controller {
   ...
   */
   ...
   function browse() {
      ...
      $this->load->model('songsplits_api_new/connection_rnmmodel');                  // Instantiate the model
      ...
      $this->layout->render_page('/songsplits_api_new/connection_rnm/connection_rnmgrid', $the_results);
      // NOTE: If you don't want to use the layout library, use the line below.
      // $this->load->view('/songsplits_api_new/connection_rnm/connection_rnmgrid', $the_results);
   ...
   function add() {
      ...
      if ( $submit != false ) {
         ...
         // ////////////////////////////////////////////////////////////////////
         $this->load->model('songsplits_api_new/connection_rnmmodel');
         ...
         */
         ...
         // $this->load->helper('url');
         redirect('/songsplits_api_new/connection_rnm/', 'location');
         ...
         */
         ...
         $this->load->library('songsplits_api_new/layout');
         $this->layout->render_page('/songsplits_api_new/connection_rnm/connection_rnmdetails', $data);
         // NOTE: If you don't want to use the layout library, use the line below.
         // $this->load->view('/songsplits_api_new/connection_rnm/connection_rnmdetails', $data);
   ...
   function modify() {
      ...
      if ( $submit != false ) {
         ...
         */
         ...
         $this->connection_rnmmodel->modify($data['id'], $data);
