<?
   ...
   $modify_url = site_url('referral/modify/');
   $delete_url = site_url('referral/delete/');
   $add_url    = site_url('referral/add/');
...
<form action='<?= $add_url; ?>' method='POST' id='frmreferral'>
<table width="100%" border="0" cellspacing="1" cellpadding="0">
<tr>
   <th align="left" class="formSecHeader">Browsing referral values</th>
   <th align="right">
...
<tbody  class="scrollingContent">
      ...
      <tr bgcolor="<?= $bgColor; ?>">
         <td align="center" nowrap="nowrap">
            <a href = "<?= $modify_url."/".$referral["referral_id"]; ?>" >Edit</a>
            &nbsp;&nbsp;&nbsp;
            <a href = "<?= $delete_url."/".$referral["referral_id"]; ?>" >Delete</a>
         </td>
   <td align="left" nowrap="nowrap"><?= $referral['date_created']; ?></td>
   <td align="left" nowrap="nowrap"><?= $referral['email']; ?></td>
   <td align="left" nowrap="nowrap"><?= $referral['new_user_id']; ?></td>
   <td align="left" nowrap="nowrap"><?= $referral['referral_id']; ?></td>
   <td align="left" nowrap="nowrap"><?= $referral['user_id']; ?></td>
</tr>
      <? } ?>
</tbody>
</table>
