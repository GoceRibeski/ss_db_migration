 ...
 *   V1.0   2016-06-16 05:10 PM   - Pradesh Chanderpaul     - Created
 *
 * @package             Manager
...
class Manager extends CI_Controller {
   ...
   */
   ...
   function browse() {
      ...
      $this->load->model('songsplits_api/managermodel');                  // Instantiate the model
      ...
      $this->layout->render_page('/songsplits_api/manager/managergrid', $the_results);
      // NOTE: If you don't want to use the layout library, use the line below.
      // $this->load->view('songsplits_api/manager/managergrid', $the_results);
   ...
   function add() {
      ...
      if ( $submit != false ) {
         ...
         // ////////////////////////////////////////////////////////////////////
         $this->load->model('songsplits_api/managermodel');
         ...
         */
         ...
         // $this->load->helper('url');
         redirect('/songsplits_api/manager/', 'location');
         ...
         */
         ...
         $this->load->library('songsplits_api/layout');
         $this->layout->render_page('/songsplits_api/manager/managerdetails', $data);
         // NOTE: If you don't want to use the layout library, use the line below.
         // $this->load->view('songsplits_api/manager/managerdetails', $data);
