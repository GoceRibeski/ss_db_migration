...
//   }
   ...
   function find($filters = NULL, $start = NULL, $count = NULL) {
      ...
      // ///////////////////////////////////////////////////////////////////////
      $this->table_record_count = $this->db_songsplits_api->count_all( 'work_history' );
      ...
      $query = $this->db_songsplits_api->get( 'work_history' );
   ...
   function retrieve_by_pkey($idField) {
      ...
      $this->db_songsplits_api->where( 'work_history_id', "$idField");
   ...
   function add( $data ) {
      ...
      $this->db_songsplits_api->insert('work_history', $data);
   ...
   function modify($keyvalue, $data) {
      ...
      $this->db_songsplits_api->where('work_history_id', $keyvalue);
      $this->db_songsplits_api->update('work_history', $data);
   ...
   function delete_by_pkey($idField) {
      ...
      // ///////////////////////////////////////////////////////////////////////
      // $this->db_songsplits_api->where('work_history_id', $idField);
      // $this->db_songsplits_api->delete('work_history');
