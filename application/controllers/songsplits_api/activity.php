...
class Activity extends CI_Controller {
   ...
   */
   ...
   function browse() {
      ...
      $this->load->model('songsplits_api/activitymodel');                  // Instantiate the model
      ...
      $this->layout->render_page('/songsplits_api/activity/activitygrid', $the_results);
      // NOTE: If you don't want to use the layout library, use the line below.
      // $this->load->view('songsplits_api/activity/activitygrid', $the_results);
   ...
   function add() {
      ...
      if ( $submit != false ) {
         ...
         // ////////////////////////////////////////////////////////////////////
         $this->load->model('songsplits_api/activitymodel');
         ...
         */
         ...
         // $this->load->helper('url');
         redirect('/songsplits_api/activity/', 'location');
         ...
         */
         ...
         $this->load->library('songsplits_api/layout');
         $this->layout->render_page('/songsplits_api/activity/activitydetails', $data);
         // NOTE: If you don't want to use the layout library, use the line below.
         // $this->load->view('songsplits_api/activity/activitydetails', $data);
