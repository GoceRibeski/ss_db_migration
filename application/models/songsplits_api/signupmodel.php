...
//   }
   ...
   function find($filters = NULL, $start = NULL, $count = NULL) {
      ...
      // ///////////////////////////////////////////////////////////////////////
      $this->table_record_count = $this->db_songsplits_api->count_all( 'signup' );
      ...
      $query = $this->db_songsplits_api->get( 'signup' );
   ...
   function retrieve_by_pkey($idField) {
      ...
      $this->db_songsplits_api->where( 'signup_id', "$idField");
   ...
   function add( $data ) {
      ...
      $this->db_songsplits_api->insert('signup', $data);
   ...
   function modify($keyvalue, $data) {
      ...
      $this->db_songsplits_api->where('signup_id', $keyvalue);
      $this->db_songsplits_api->update('signup', $data);
   ...
   function delete_by_pkey($idField) {
      ...
      // ///////////////////////////////////////////////////////////////////////
      // $this->db_songsplits_api->where('signup_id', $idField);
      // $this->db_songsplits_api->delete('signup');
