...
//   }
   ...
   function find($filters = NULL, $start = NULL, $count = NULL) {
      ...
      // ///////////////////////////////////////////////////////////////////////
      $this->table_record_count = $this->db_songsplits_api->count_all( 'access_control' );
      ...
      $query = $this->db_songsplits_api->get( 'access_control' );
   ...
   function retrieve_by_pkey($idField) {
      ...
      $this->db_songsplits_api->where( 'ac_id', "$idField");
   ...
   function add( $data ) {
      ...
      $this->db_songsplits_api->insert('access_control', $data);
   ...
   function modify($keyvalue, $data) {
      ...
      $this->db_songsplits_api->where('ac_id', $keyvalue);
      $this->db_songsplits_api->update('access_control', $data);
   ...
   function delete_by_pkey($idField) {
      ...
      // ///////////////////////////////////////////////////////////////////////
      // $this->db_songsplits_api->where('ac_id', $idField);
      // $this->db_songsplits_api->delete('access_control');
