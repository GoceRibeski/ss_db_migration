...
class User_group extends CI_Controller {
   ...
   */
   ...
   function browse() {
      ...
      $this->load->model('songsplits_api_new/user_groupmodel');                  // Instantiate the model
      ...
      $this->layout->render_page('/songsplits_api_new/user_group/user_groupgrid', $the_results);
      // NOTE: If you don't want to use the layout library, use the line below.
      // $this->load->view('/songsplits_api_new/user_group/user_groupgrid', $the_results);
   ...
   function add() {
      ...
      if ( $submit != false ) {
         ...
         // ////////////////////////////////////////////////////////////////////
         $this->load->model('songsplits_api_new/user_groupmodel');
         ...
         */
         ...
         // $this->load->helper('url');
         redirect('/songsplits_api_new/user_group/', 'location');
         ...
         */
         ...
         $this->load->library('songsplits_api_new/layout');
         $this->layout->render_page('/songsplits_api_new/user_group/user_groupdetails', $data);
         // NOTE: If you don't want to use the layout library, use the line below.
         // $this->load->view('/songsplits_api_new/user_group/user_groupdetails', $data);
