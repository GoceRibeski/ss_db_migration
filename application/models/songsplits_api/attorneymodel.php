...
//   }
   ...
   function find($filters = NULL, $start = NULL, $count = NULL) {
      ...
      // ///////////////////////////////////////////////////////////////////////
      $this->table_record_count = $this->db_songsplits_api->count_all( 'attorney' );
      ...
      $query = $this->db_songsplits_api->get( 'attorney' );
   ...
   function add( $data ) {
      ...
      $this->db_songsplits_api->insert('attorney', $data);
   ...
   function modify($keyvalue, $data) {
      ...
      $this->db_songsplits_api->update('attorney', $data);
   ...
   function delete_by_pkey($idField) {
      ...
      // ///////////////////////////////////////////////////////////////////////
      // $this->db_songsplits_api->where('attorney_id', $idField);
      // $this->db_songsplits_api->delete('attorney');
