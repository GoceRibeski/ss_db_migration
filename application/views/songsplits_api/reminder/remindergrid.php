<?
   ...
   $modify_url = site_url('reminder/modify/');
   $delete_url = site_url('reminder/delete/');
   $add_url    = site_url('reminder/add/');
...
<form action='<?= $add_url; ?>' method='POST' id='frmreminder'>
<table width="100%" border="0" cellspacing="1" cellpadding="0">
<tr>
   <th align="left" class="formSecHeader">Browsing reminder values</th>
   <th align="right">
...
<tbody  class="scrollingContent">
      ...
      <tr bgcolor="<?= $bgColor; ?>">
         <td align="center" nowrap="nowrap">
            <a href = "<?= $modify_url."/".$reminder["reminder_id"]; ?>" >Edit</a>
            &nbsp;&nbsp;&nbsp;
            <a href = "<?= $delete_url."/".$reminder["reminder_id"]; ?>" >Delete</a>
         </td>
   <td align="left" nowrap="nowrap"><?= $reminder['date_created']; ?></td>
   <td align="left" nowrap="nowrap"><?= $reminder['recieve_user_id']; ?></td>
   <td align="left" nowrap="nowrap"><?= $reminder['reminder_id']; ?></td>
   <td align="left" nowrap="nowrap"><?= $reminder['send_user_id']; ?></td>
   <td align="left" nowrap="nowrap"><?= $reminder['split_id']; ?></td>
   <td align="left" nowrap="nowrap"><?= $reminder['work_id']; ?></td>
</tr>
      <? } ?>
</tbody>
</table>
