...
class User_group_perm extends CI_Controller {
   ...
   */
   ...
   function browse() {
      ...
      $this->load->model('songsplits_api_new/user_group_permmodel');                  // Instantiate the model
      ...
      $this->layout->render_page('/songsplits_api_new/user_group_perm/user_group_permgrid', $the_results);
      // NOTE: If you don't want to use the layout library, use the line below.
      // $this->load->view('/songsplits_api_new/user_group_perm/user_group_permgrid', $the_results);
   ...
   function add() {
      ...
      if ( $submit != false ) {
         ...
         // ////////////////////////////////////////////////////////////////////
         $this->load->model('songsplits_api_new/user_group_permmodel');
         ...
         */
         ...
         // $this->load->helper('url');
         redirect('/songsplits_api_new/user_group_perm/', 'location');
         ...
         */
         ...
         $this->load->library('songsplits_api_new/layout');
         $this->layout->render_page('/songsplits_api_new/user_group_perm/user_group_permdetails', $data);
         // NOTE: If you don't want to use the layout library, use the line below.
         // $this->load->view('/songsplits_api_new/user_group_perm/user_group_permdetails', $data);
