...
//   }
   ...
   function find($filters = NULL, $start = NULL, $count = NULL) {
      ...
      // ///////////////////////////////////////////////////////////////////////
      $this->table_record_count = $this->db_songsplits_api->count_all( 'work' );
      ...
      $query = $this->db_songsplits_api->get( 'work' );
   ...
   function retrieve_by_pkey($idField) {
      ...
      $this->db_songsplits_api->where( 'work_id', "$idField");
   ...
   function add( $data ) {
      ...
      $this->db_songsplits_api->insert('work', $data);
   ...
   function modify($keyvalue, $data) {
      ...
      $this->db_songsplits_api->where('work_id', $keyvalue);
      $this->db_songsplits_api->update('work', $data);
   ...
   function delete_by_pkey($idField) {
      ...
      // ///////////////////////////////////////////////////////////////////////
      // $this->db_songsplits_api->where('work_id', $idField);
      // $this->db_songsplits_api->delete('work');
