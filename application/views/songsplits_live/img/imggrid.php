<?
   ...
   $modify_url = site_url('img/modify/');
   $delete_url = site_url('img/delete/');
   $add_url    = site_url('img/add/');
...
<form action='<?= $add_url; ?>' method='POST' id='frmimg'>
<table width="100%" border="0" cellspacing="1" cellpadding="0">
<tr>
   <th align="left" class="formSecHeader">Browsing img values</th>
   <th align="right">
...
<tbody  class="scrollingContent">
      ...
      <tr bgcolor="<?= $bgColor; ?>">
         <td align="center" nowrap="nowrap">
            <a href = "<?= $modify_url."/".$img["img_id"]; ?>" >Edit</a>
            &nbsp;&nbsp;&nbsp;
            <a href = "<?= $delete_url."/".$img["img_id"]; ?>" >Delete</a>
         </td>
   <td align="left" nowrap="nowrap"><?= $img['img_id']; ?></td>
   <td align="left" nowrap="nowrap"><?= $img['img_name']; ?></td>
</tr>
      <? } ?>
</tbody>
</table>
