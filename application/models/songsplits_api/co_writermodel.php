<?php
class Co_writerModel extends CI_Model {
/**
 * MODULE NAME   : co_writermodel.php
 *
 * DESCRIPTION   : Co_writer model controller
 *
 * MODIFICATION HISTORY
 *   V1.0   2016-06-16 05:20 PM   - Pradesh Chanderpaul     - Created
 *
 * @package             co_writer
 * @subpackage          Co_writer model component Class
...
//   }
   ...
   function find($filters = NULL, $start = NULL, $count = NULL) {
      ...
      // ///////////////////////////////////////////////////////////////////////
      $this->table_record_count = $this->db_songsplits_api->count_all( 'co_writer' );
      ...
      $query = $this->db_songsplits_api->get( 'co_writer' );
      ...
      if ($query->num_rows() > 0) {
         ...
         foreach ($query->result_array() as $row)      // Go through the result set
         {
			...
			$query_results['co_writer_id']		 = $row['co_writer_id'];
   ...
   function add( $data ) {
      ...
      $this->db_songsplits_api->insert('co_writer', $data);
   ...
   function modify($keyvalue, $data) {
      ...
      $this->db_songsplits_api->update('co_writer', $data);
   ...
   function delete_by_pkey($idField) {
      ...
      // ///////////////////////////////////////////////////////////////////////
      // $this->db_songsplits_api->where('id', $idField);
      // $this->db_songsplits_api->delete('co_writer');

      return true;

   }

	function get_Co_writer_id() {
		return $this->co_writer_id;	}

	function set_Co_writer_id($co_writer_id) {
		$this->co_writer_id = $co_writer_id;	}
