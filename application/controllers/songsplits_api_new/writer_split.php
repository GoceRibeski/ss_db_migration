...
class Writer_split extends CI_Controller {
   ...
   */
   ...
   function browse() {
      ...
      $this->load->model('songsplits_api_new/writer_splitmodel');                  // Instantiate the model
      ...
      $this->layout->render_page('/songsplits_api_new/writer_split/writer_splitgrid', $the_results);
      // NOTE: If you don't want to use the layout library, use the line below.
      // $this->load->view('/songsplits_api_new/writer_split/writer_splitgrid', $the_results);
   ...
   function add() {
      ...
      if ( $submit != false ) {
         ...
         */
         ...
         // $this->load->helper('url');
         redirect('/songsplits_api_new/writer_split/', 'location');
         ...
         */
         ...
         $this->load->library('songsplits_api_new/layout');
         $this->layout->render_page('/songsplits_api_new/writer_split/writer_splitdetails', $data);
         // NOTE: If you don't want to use the layout library, use the line below.
         // $this->load->view('/songsplits_api_new/writer_split/writer_splitdetails', $data);
