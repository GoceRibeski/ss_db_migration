...
//   }
   ...
   function find($filters = NULL, $start = NULL, $count = NULL) {
      ...
      // ///////////////////////////////////////////////////////////////////////
      $this->table_record_count = $this->db_songsplits_api_new->count_all( 'administration' );
      ...
      $query = $this->db_songsplits_api_new->get( 'administration' );
   ...
   function add( $data ) {
      ...
      $this->db_songsplits_api_new->insert('administration', $data);
   ...
   function modify($keyvalue, $data) {
      ...
      $this->db_songsplits_api_new->update('administration', $data);
   ...
   function delete_by_pkey($idField) {
      ...
      // ///////////////////////////////////////////////////////////////////////
      // $this->db_songsplits_api_new->where('id', $idField);
      // $this->db_songsplits_api_new->delete('administration');
