<?
   ...
   $modify_url = site_url('artist/modify/');
   $delete_url = site_url('artist/delete/');
   $add_url    = site_url('artist/add/');
...
<form action='<?= $add_url; ?>' method='POST' id='frmartist'>
<table width="100%" border="0" cellspacing="1" cellpadding="0">
<tr>
   <th align="left" class="formSecHeader">Browsing artist values</th>
   <th align="right">
...
<tbody  class="scrollingContent">
      ...
      <tr bgcolor="<?= $bgColor; ?>">
         <td align="center" nowrap="nowrap">
            <a href = "<?= $modify_url."/".$artist["artist_id"]; ?>" >Edit</a>
            &nbsp;&nbsp;&nbsp;
            <a href = "<?= $delete_url."/".$artist["artist_id"]; ?>" >Delete</a>
         </td>
   <td align="left" nowrap="nowrap"><?= $artist['artist_id']; ?></td>
   <td align="left" nowrap="nowrap"><?= $artist['temp_id']; ?></td>
   <td align="left" nowrap="nowrap"><?= $artist['artist_name']; ?></td>
   <td align="left" nowrap="nowrap"><?= $artist['alt_names']; ?></td>
   <td align="left" nowrap="nowrap"><?= $artist['label']; ?></td>
</tr>
      <? } ?>
</tbody>
</table>
