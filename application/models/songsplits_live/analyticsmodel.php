...
/**
 * MODULE NAME   : analyticsmodel.php
 *
 * DESCRIPTION   : Analytics model controller
 *
 * MODIFICATION HISTORY
 *   V1.0   2016-06-16 05:21 PM   - Pradesh Chanderpaul     - Created
 *
 * @package             analytics
 * @subpackage          Analytics model component Class
...
//      return $this->find(array('' => '$key_value'));
//   }
   ...
   function find($filters = NULL, $start = NULL, $count = NULL) {
      ...
      // ///////////////////////////////////////////////////////////////////////
      $this->table_record_count = $this->db_songsplits_live->count_all( 'analytics' );
      ...
      $query = $this->db_songsplits_live->get( 'analytics' );
      ...
      if ($query->num_rows() > 0) {
         ...
         foreach ($query->result_array() as $row)      // Go through the result set
         {
			...
			$query_results['split_count']		 = $row['split_count'];
   ...
   function retrieve_by_pkey($idField) {
      ...
      $this->db_songsplits_live->where( '', "$idField");
   ...
   function add( $data ) {
      ...
      $this->db_songsplits_live->insert('analytics', $data);
   ...
   function modify($keyvalue, $data) {
      ...
      $this->db_songsplits_live->where('', $keyvalue);
      $this->db_songsplits_live->update('analytics', $data);
   ...
   function delete_by_pkey($idField) {
      ...
      // ///////////////////////////////////////////////////////////////////////
      // $this->db_songsplits_live->where('', $idField);
      // $this->db_songsplits_live->delete('analytics');
	...
	function get_Split_count() {
		return $this->split_count;	}

	function set_Split_count($split_count) {
