...
//   }
   ...
   function find($filters = NULL, $start = NULL, $count = NULL) {
      ...
      // ///////////////////////////////////////////////////////////////////////
      $this->table_record_count = $this->db_songsplits_api->count_all( 'work_meta' );
      ...
      $query = $this->db_songsplits_api->get( 'work_meta' );
   ...
   function retrieve_by_pkey($idField) {
      ...
      $this->db_songsplits_api->where( 'work_meta_id_id', "$idField");
   ...
   function add( $data ) {
      ...
      $this->db_songsplits_api->insert('work_meta', $data);
   ...
   function modify($keyvalue, $data) {
      ...
      $this->db_songsplits_api->where('work_meta_id_id', $keyvalue);
      $this->db_songsplits_api->update('work_meta', $data);
   ...
   function delete_by_pkey($idField) {
      ...
      // ///////////////////////////////////////////////////////////////////////
      // $this->db_songsplits_api->where('work_meta_id_id', $idField);
      // $this->db_songsplits_api->delete('work_meta');
