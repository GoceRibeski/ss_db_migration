...
class Work_history extends CI_Controller {
   ...
   */
   ...
   function browse() {
      ...
      $this->load->model('songsplits_api/work_historymodel');                  // Instantiate the model
      ...
      $this->layout->render_page('/songsplits_api/work_history/work_historygrid', $the_results);
      // NOTE: If you don't want to use the layout library, use the line below.
      // $this->load->view('songsplits_api/work_history/work_historygrid', $the_results);
   ...
   function add() {
      ...
      if ( $submit != false ) {
         ...
         // ////////////////////////////////////////////////////////////////////
         $this->load->model('songsplits_api/work_historymodel');
         ...
         */
         ...
         // $this->load->helper('url');
         redirect('/songsplits_api/work_history/', 'location');
         ...
         */
         ...
         $this->load->library('songsplits_api/layout');
         $this->layout->render_page('/songsplits_api/work_history/work_historydetails', $data);
         // NOTE: If you don't want to use the layout library, use the line below.
         // $this->load->view('songsplits_api/work_history/work_historydetails', $data);
