...
<tbody  class="scrollingContent">
      ...
      <tr bgcolor="<?= $bgColor; ?>">
         <td align="center" nowrap="nowrap">
            <a href = "<?= $modify_url."/".$connection_rnm["id"]; ?>" >Edit</a>
            &nbsp;&nbsp;&nbsp;
            <a href = "<?= $delete_url."/".$connection_rnm["id"]; ?>" >Delete</a>
         </td>
   <td align="left" nowrap="nowrap"><?= $connection_rnm['connection_id']; ?></td>
   <td align="left" nowrap="nowrap"><?= $connection_rnm['id']; ?></td>
   <td align="left" nowrap="nowrap"><?= $connection_rnm['user_id']; ?></td>
</tr>
      <? } ?>
</tbody>
</table>
