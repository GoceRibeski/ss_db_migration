...
class Access_control extends CI_Controller {
   ...
   */
   ...
   function browse() {
      ...
      $this->load->model('songsplits_api/access_controlmodel');                  // Instantiate the model
...
//        die(__FILE__.__LINE__);
      ...
      $this->layout->render_page('/songsplits_api/access_control/access_controlgrid', $the_results);
      // NOTE: If you don't want to use the layout library, use the line below.
      // $this->load->view('songsplits_api/access_control/access_controlgrid', $the_results);
   ...
   function add() {
      ...
      if ( $submit != false ) {
         ...
         // ////////////////////////////////////////////////////////////////////
         $this->load->model('songsplits_api/access_controlmodel');
         ...
         */
         ...
         // $this->load->helper('url');
         redirect('/songsplits_api/access_control/', 'location');
         ...
         */
         ...
         $this->load->library('songsplits_api/layout');
         $this->layout->render_page('/songsplits_api/access_control/access_controldetails', $data);
         // NOTE: If you don't want to use the layout library, use the line below.
         // $this->load->view('songsplits_api/access_control/access_controldetails', $data);
