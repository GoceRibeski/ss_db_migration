...
//   }
   ...
   function find($filters = NULL, $start = NULL, $count = NULL) {
      ...
      // ///////////////////////////////////////////////////////////////////////
      $this->table_record_count = $this->db_songsplits_api_new->count_all( 'language' );
      ...
      $query = $this->db_songsplits_api_new->get( 'language' );
   ...
   function retrieve_by_pkey($idField) {
      ...
      $this->db_songsplits_api_new->where( 'language_id', "$idField");
   ...
   function add( $data ) {
      ...
      $this->db_songsplits_api_new->insert('language', $data);
   ...
   function modify($keyvalue, $data) {
      ...
      $this->db_songsplits_api_new->where('language_id', $keyvalue);
      $this->db_songsplits_api_new->update('language', $data);
   ...
   function delete_by_pkey($idField) {
      ...
      // ///////////////////////////////////////////////////////////////////////
      // $this->db_songsplits_api_new->where('language_id', $idField);
      // $this->db_songsplits_api_new->delete('language');
