...
//   }
   ...
   function find($filters = NULL, $start = NULL, $count = NULL) {
      ...
      // ///////////////////////////////////////////////////////////////////////
      $this->table_record_count = $this->db_songsplits_api_new->count_all( 'manager' );
      ...
      $query = $this->db_songsplits_api_new->get( 'manager' );
   ...
   function add( $data ) {
      ...
      $this->db_songsplits_api_new->insert('manager', $data);
   ...
   function modify($keyvalue, $data) {
      ...
      $this->db_songsplits_api_new->update('manager', $data);
   ...
   function delete_by_pkey($idField) {
      ...
      // ///////////////////////////////////////////////////////////////////////
      // $this->db_songsplits_api_new->where('attorney_id', $idField);
      // $this->db_songsplits_api_new->delete('manager');
