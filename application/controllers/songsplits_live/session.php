...
class Session extends CI_Controller {
   ...
   */
   ...
   function browse() {
      ...
      $this->load->model('songsplits_live/sessionmodel');                  // Instantiate the model
      ...
      $this->layout->render_page('/songsplits_live/session/sessiongrid', $the_results);
      // NOTE: If you don't want to use the layout library, use the line below.
      // $this->load->view('songsplits_live/session/sessiongrid', $the_results);
   ...
   function add() {
      ...
      if ( $submit != false ) {
         ...
         // ////////////////////////////////////////////////////////////////////
         $this->load->model('songsplits_live/sessionmodel');
         ...
         */
         ...
         // $this->load->helper('url');
         redirect('/songsplits_live/session/', 'location');
         ...
         */
         ...
         $this->load->library('songsplits_live/layout');
         $this->layout->render_page('/songsplits_live/session/sessiondetails', $data);
         // NOTE: If you don't want to use the layout library, use the line below.
         // $this->load->view('songsplits_live/session/sessiondetails', $data);
   ...
   function modify() {
      ...
      if ( $submit != false ) {
         ...
         */
         ...
         $this->sessionmodel->modify($data['id'], $data);
