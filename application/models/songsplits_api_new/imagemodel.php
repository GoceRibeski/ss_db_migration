...
/**
 * MODULE NAME   : imagemodel.php
 *
 * DESCRIPTION   : Image model controller
 *
 * MODIFICATION HISTORY
 *   V1.0   2016-06-20 10:59 AM   - Pradesh Chanderpaul     - Created
 *
 * @package             image
 * @subpackage          Image model component Class
...
//   }
   ...
   function find($filters = NULL, $start = NULL, $count = NULL) {
      ...
      // ///////////////////////////////////////////////////////////////////////
      $this->table_record_count = $this->db_songsplits_api_new->count_all( 'image' );
      ...
      $query = $this->db_songsplits_api_new->get( 'image' );
      ...
      if ($query->num_rows() > 0) {
         ...
         foreach ($query->result_array() as $row)      // Go through the result set
         {
			...
			$query_results['img_link']		 = $row['img_link'];
   ...
   function retrieve_by_pkey($idField) {
      ...
      $this->db_songsplits_api_new->where( 'img_id', "$idField");
   ...
   function add( $data ) {
      ...
      $this->db_songsplits_api_new->insert('image', $data);
   ...
   function modify($keyvalue, $data) {
      ...
      $this->db_songsplits_api_new->where('img_id', $keyvalue);
      $this->db_songsplits_api_new->update('image', $data);
   ...
   function delete_by_pkey($idField) {
      ...
      // ///////////////////////////////////////////////////////////////////////
      // $this->db_songsplits_api_new->where('img_id', $idField);
      // $this->db_songsplits_api_new->delete('image');
	...
	function set_Img_link($img_link) {
