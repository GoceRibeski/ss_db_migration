...
<table cellspacing="2" cellpadding="2" border="0" width="100%">
	...
	<tr valign='top' height='20'>
            ...
            <td>
               <select name='main_user_type' id='main_user_type' ><option value='writer'>writer</option><option value='manager'>manager</option><option value='attorney'>attorney</option><option value='publisher'>publisher</option><option value='other'>other</option></select>
            </td>
         </tr>
	<tr valign='top' height='20'>
