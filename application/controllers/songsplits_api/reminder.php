...
class Reminder extends CI_Controller {
   ...
   */
   ...
   function browse() {
      ...
      $this->load->model('songsplits_api/remindermodel');                  // Instantiate the model
      ...
      $this->layout->render_page('/songsplits_api/reminder/remindergrid', $the_results);
      // NOTE: If you don't want to use the layout library, use the line below.
      // $this->load->view('songsplits_api/reminder/remindergrid', $the_results);
   ...
   function add() {
      ...
      if ( $submit != false ) {
         ...
         // ////////////////////////////////////////////////////////////////////
         $this->load->model('songsplits_api/remindermodel');
         ...
         */
         ...
         // $this->load->helper('url');
         redirect('/songsplits_api/reminder/', 'location');
         ...
         */
         ...
         $this->load->library('songsplits_api/layout');
         $this->layout->render_page('/songsplits_api/reminder/reminderdetails', $data);
         // NOTE: If you don't want to use the layout library, use the line below.
         // $this->load->view('songsplits_api/reminder/reminderdetails', $data);
