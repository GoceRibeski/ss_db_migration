<?
   ...
   $modify_url = site_url('social/modify/');
   $delete_url = site_url('social/delete/');
   $add_url    = site_url('social/add/');
...
<form action='<?= $add_url; ?>' method='POST' id='frmsocial'>
<table width="100%" border="0" cellspacing="1" cellpadding="0">
<tr>
   <th align="left" class="formSecHeader">Browsing social values</th>
   <th align="right">
...
<tbody  class="scrollingContent">
      ...
      <tr bgcolor="<?= $bgColor; ?>">
         <td align="center" nowrap="nowrap">
            <a href = "<?= $modify_url."/".$social["social_id"]; ?>" >Edit</a>
            &nbsp;&nbsp;&nbsp;
            <a href = "<?= $delete_url."/".$social["social_id"]; ?>" >Delete</a>
         </td>
   <td align="left" nowrap="nowrap"><?= $social['facebook_access_token']; ?></td>
   <td align="left" nowrap="nowrap"><?= $social['facebook_id']; ?></td>
   <td align="left" nowrap="nowrap"><?= $social['google_plus_id']; ?></td>
   <td align="left" nowrap="nowrap"><?= $social['social_id']; ?></td>
   <td align="left" nowrap="nowrap"><?= $social['twitter_access_token']; ?></td>
   <td align="left" nowrap="nowrap"><?= $social['twitter_id']; ?></td>
   <td align="left" nowrap="nowrap"><?= $social['twitter_secret']; ?></td>
   <td align="left" nowrap="nowrap"><?= $social['user_id']; ?></td>
</tr>
      <? } ?>
</tbody>
</table>
