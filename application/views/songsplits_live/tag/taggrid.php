<?
   ...
   $modify_url = site_url('tag/modify/');
   $delete_url = site_url('tag/delete/');
   $add_url    = site_url('tag/add/');
...
<form action='<?= $add_url; ?>' method='POST' id='frmtag'>
<table width="100%" border="0" cellspacing="1" cellpadding="0">
<tr>
   <th align="left" class="formSecHeader">Browsing tag values</th>
   <th align="right">
...
<tbody  class="scrollingContent">
      ...
      <tr bgcolor="<?= $bgColor; ?>">
         <td align="center" nowrap="nowrap">
            <a href = "<?= $modify_url."/".$tag["tag_id"]; ?>" >Edit</a>
            &nbsp;&nbsp;&nbsp;
            <a href = "<?= $delete_url."/".$tag["tag_id"]; ?>" >Delete</a>
         </td>
   <td align="left" nowrap="nowrap"><?= $tag['tag_id']; ?></td>
   <td align="left" nowrap="nowrap"><?= $tag['song_id']; ?></td>
   <td align="left" nowrap="nowrap"><?= $tag['writer_id']; ?></td>
   <td align="left" nowrap="nowrap"><?= $tag['tag_type_id']; ?></td>
   <td align="left" nowrap="nowrap"><?= $tag['tag_name']; ?></td>
   <td align="left" nowrap="nowrap"><?= $tag['created']; ?></td>
   <td align="left" nowrap="nowrap"><?= $tag['other_id']; ?></td>
</tr>
      <? } ?>
</tbody>
</table>
