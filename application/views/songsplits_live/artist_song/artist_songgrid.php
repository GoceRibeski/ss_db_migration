<?
   ...
   $modify_url = site_url('artist_song/modify/');
   $delete_url = site_url('artist_song/delete/');
   $add_url    = site_url('artist_song/add/');
...
<form action='<?= $add_url; ?>' method='POST' id='frmartist_song'>
<table width="100%" border="0" cellspacing="1" cellpadding="0">
<tr>
   <th align="left" class="formSecHeader">Browsing artist_song values</th>
   <th align="right">
...
<tbody  class="scrollingContent">
      ...
      <?
         $i = 0;
         foreach ($artist_song_list as $artist_song) {
            $i++;
            if (($i%2)==0) { $bgColor = "#FFFFFF"; } else { $bgColor = "#C0C0C0"; }
      ?>
      <tr bgcolor="<?= $bgColor; ?>">
         <td align="center" nowrap="nowrap">
            <a href = "<?= $modify_url."/".$artist_song["artist_song_id"]; ?>" >Edit</a>
            &nbsp;&nbsp;&nbsp;
            <a href = "<?= $delete_url."/".$artist_song["artist_song_id"]; ?>" >Delete</a>
         </td>
   <td align="left" nowrap="nowrap"><?= $artist_song['artist_song_id']; ?></td>
   <td align="left" nowrap="nowrap"><?= $artist_song['artist_id']; ?></td>
   <td align="left" nowrap="nowrap"><?= $artist_song['song_id']; ?></td>
</tr>
      <? } ?>
</tbody>
</table>
