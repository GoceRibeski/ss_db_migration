...
class Session extends CI_Controller {
   ...
   */
   ...
   function browse() {
      ...
      $this->load->model('songsplits_api/sessionmodel');                  // Instantiate the model
      ...
      $this->layout->render_page('/songsplits_api/session/sessiongrid', $the_results);
      // NOTE: If you don't want to use the layout library, use the line below.
      // $this->load->view('songsplits_api/session/sessiongrid', $the_results);
   ...
   function add() {
      ...
      if ( $submit != false ) {
         ...
         // ////////////////////////////////////////////////////////////////////
         $this->load->model('songsplits_api/sessionmodel');
         ...
         */
         ...
         // $this->load->helper('url');
         redirect('/songsplits_api/session/', 'location');
         ...
         */
         ...
         $this->load->library('songsplits_api/layout');
         $this->layout->render_page('/songsplits_api/session/sessiondetails', $data);
         // NOTE: If you don't want to use the layout library, use the line below.
         // $this->load->view('songsplits_api/session/sessiondetails', $data);
