...
//   }
   ...
   function find($filters = NULL, $start = NULL, $count = NULL) {
      ...
      // ///////////////////////////////////////////////////////////////////////
      $this->table_record_count = $this->db_songsplits_live->count_all( 'session' );
      ...
      $query = $this->db_songsplits_live->get( 'session' );
      ...
      if ($query->num_rows() > 0) {
         ...
         foreach ($query->result_array() as $row)      // Go through the result set
         {
			...
			$query_results['is_admin']		 = $row['is_admin'];
   ...
   function add( $data ) {
      ...
      $this->db_songsplits_live->insert('session', $data);
   ...
   function modify($keyvalue, $data) {
      ...
      $this->db_songsplits_live->update('session', $data);
   ...
   function delete_by_pkey($idField) {
      ...
      // ///////////////////////////////////////////////////////////////////////
      // $this->db_songsplits_live->where('id', $idField);
      // $this->db_songsplits_live->delete('session');
