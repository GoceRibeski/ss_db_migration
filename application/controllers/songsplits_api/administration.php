...
class Administration extends CI_Controller {
   ...
   */
   ...
   function browse() {
      ...
      $this->load->model('songsplits_api/administrationmodel');                  // Instantiate the model
      ...
      $this->layout->render_page('/songsplits_api/administration/administrationgrid', $the_results);
      // NOTE: If you don't want to use the layout library, use the line below.
      // $this->load->view('songsplits_api/administration/administrationgrid', $the_results);
   ...
   function add() {
      ...
      if ( $submit != false ) {
         ...
         // ////////////////////////////////////////////////////////////////////
         $this->load->model('songsplits_api/administrationmodel');
         ...
         */
         ...
         // $this->load->helper('url');
         redirect('/songsplits_api/administration/', 'location');
         ...
         */
         ...
         $this->load->library('songsplits_api/layout');
         $this->layout->render_page('/songsplits_api/administration/administrationdetails', $data);
         // NOTE: If you don't want to use the layout library, use the line below.
         // $this->load->view('songsplits_api/administration/administrationdetails', $data);
