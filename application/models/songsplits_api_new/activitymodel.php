...
//   }
   ...
   function find($filters = NULL, $start = NULL, $count = NULL) {
      ...
      // ///////////////////////////////////////////////////////////////////////
      $this->table_record_count = $this->db_songsplits_api_new->count_all( 'activity' );
      ...
      $query = $this->db_songsplits_api_new->get( 'activity' );
   ...
   function retrieve_by_pkey($idField) {
      ...
      $this->db_songsplits_api_new->where( 'activity_id', "$idField");
   ...
   function add( $data ) {
      ...
      $this->db_songsplits_api_new->insert('activity', $data);
   ...
   function modify($keyvalue, $data) {
      ...
      $this->db_songsplits_api_new->where('activity_id', $keyvalue);
      $this->db_songsplits_api_new->update('activity', $data);
   ...
   function delete_by_pkey($idField) {
      ...
      // ///////////////////////////////////////////////////////////////////////
      // $this->db_songsplits_api_new->where('activity_id', $idField);
      // $this->db_songsplits_api_new->delete('activity');
