<?
   ...
   $modify_url = site_url('harvest/modify/');
   $delete_url = site_url('harvest/delete/');
   $add_url    = site_url('harvest/add/');
...
<form action='<?= $add_url; ?>' method='POST' id='frmharvest'>
<table width="100%" border="0" cellspacing="1" cellpadding="0">
<tr>
   <th align="left" class="formSecHeader">Browsing harvest values</th>
   <th align="right">
...
<tbody  class="scrollingContent">
      ...
      <tr bgcolor="<?= $bgColor; ?>">
         <td align="center" nowrap="nowrap">
            <a href = "<?= $modify_url."/".$harvest["id"]; ?>" >Edit</a>
            &nbsp;&nbsp;&nbsp;
            <a href = "<?= $delete_url."/".$harvest["id"]; ?>" >Delete</a>
         </td>
   <td align="left" nowrap="nowrap"><?= $harvest['id']; ?></td>
   <td align="left" nowrap="nowrap"><?= $harvest['first_name']; ?></td>
   <td align="left" nowrap="nowrap"><?= $harvest['last_name']; ?></td>
   <td align="left" nowrap="nowrap"><?= $harvest['email']; ?></td>
   <td align="left" nowrap="nowrap"><?= $harvest['society']; ?></td>
   <td align="left" nowrap="nowrap"><?= $harvest['code']; ?></td>
   <td align="left" nowrap="nowrap"><?= $harvest['status']; ?></td>
   <td align="left" nowrap="nowrap"><?= $harvest['created_datatime']; ?></td>
</tr>
      <? } ?>
</tbody>
</table>
