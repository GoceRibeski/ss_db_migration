...
//      return $this->find(array('administration_id' => '$key_value'));
//   }
   ...
   function find($filters = NULL, $start = NULL, $count = NULL) {
      ...
      // ///////////////////////////////////////////////////////////////////////
      $this->table_record_count = $this->db_songsplits_live->count_all( 'administration' );
      ...
      $query = $this->db_songsplits_live->get( 'administration' );
      ...
      if ($query->num_rows() > 0) {
         ...
         foreach ($query->result_array() as $row)      // Go through the result set
         {
			...
			$query_results['administration_id']		 = $row['administration_id'];
   ...
   function retrieve_by_pkey($idField) {
      ...
      $this->db_songsplits_live->where( 'administration_id', "$idField");
   ...
   function add( $data ) {
      ...
      $this->db_songsplits_live->insert('administration', $data);
   ...
   function modify($keyvalue, $data) {
      ...
      $this->db_songsplits_live->where('administration_id', $keyvalue);
      $this->db_songsplits_live->update('administration', $data);
   ...
   function delete_by_pkey($idField) {
      ...
      // ///////////////////////////////////////////////////////////////////////
      // $this->db_songsplits_live->where('administration_id', $idField);
      // $this->db_songsplits_live->delete('administration');
	...
	function set_Administration_id($administration_id) {
