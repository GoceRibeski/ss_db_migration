<?
   ...
   $modify_url = site_url('status/modify/');
   $delete_url = site_url('status/delete/');
   $add_url    = site_url('status/add/');
...
<form action='<?= $add_url; ?>' method='POST' id='frmstatus'>
<table width="100%" border="0" cellspacing="1" cellpadding="0">
<tr>
   <th align="left" class="formSecHeader">Browsing status values</th>
   <th align="right">
...
<tbody  class="scrollingContent">
      ...
      <tr bgcolor="<?= $bgColor; ?>">
         <td align="center" nowrap="nowrap">
            <a href = "<?= $modify_url."/".$status["status_id"]; ?>" >Edit</a>
            &nbsp;&nbsp;&nbsp;
            <a href = "<?= $delete_url."/".$status["status_id"]; ?>" >Delete</a>
         </td>
   <td align="left" nowrap="nowrap"><?= $status['status_id']; ?></td>
   <td align="left" nowrap="nowrap"><?= $status['status_name']; ?></td>
</tr>
      <? } ?>
</tbody>
</table>
