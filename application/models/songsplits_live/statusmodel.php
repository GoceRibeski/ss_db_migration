...
/**
 * MODULE NAME   : statusmodel.php
 *
 * DESCRIPTION   : Status model controller
 *
 * MODIFICATION HISTORY
 *   V1.0   2016-06-16 05:26 PM   - Pradesh Chanderpaul     - Created
 *
 * @package             status
 * @subpackage          Status model component Class
...
//      return $this->find(array('status_id' => '$key_value'));
//   }
   ...
   function find($filters = NULL, $start = NULL, $count = NULL) {
      ...
      // ///////////////////////////////////////////////////////////////////////
      $this->table_record_count = $this->db_songsplits_live->count_all( 'status' );
      ...
      $query = $this->db_songsplits_live->get( 'status' );
      ...
      if ($query->num_rows() > 0) {
         ...
         foreach ($query->result_array() as $row)      // Go through the result set
         {
			...
			$query_results['status_name']		 = $row['status_name'];
   ...
   function retrieve_by_pkey($idField) {
      ...
      $this->db_songsplits_live->where( 'status_id', "$idField");
   ...
   function add( $data ) {
      ...
      $this->db_songsplits_live->insert('status', $data);
   ...
   function modify($keyvalue, $data) {
      ...
      $this->db_songsplits_live->where('status_id', $keyvalue);
      $this->db_songsplits_live->update('status', $data);
   ...
   function delete_by_pkey($idField) {
      ...
      // ///////////////////////////////////////////////////////////////////////
      // $this->db_songsplits_live->where('status_id', $idField);
      // $this->db_songsplits_live->delete('status');
	...
	function set_Status_name($status_name) {
