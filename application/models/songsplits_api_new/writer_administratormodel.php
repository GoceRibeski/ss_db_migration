...
//   }
   ...
   function find($filters = NULL, $start = NULL, $count = NULL) {
      ...
      // ///////////////////////////////////////////////////////////////////////
      $this->table_record_count = $this->db_songsplits_api_new->count_all( 'writer_administrator' );
      ...
      $query = $this->db_songsplits_api_new->get( 'writer_administrator' );
   ...
   function retrieve_by_pkey($idField) {
      ...
      $this->db_songsplits_api_new->where( 'wa_id', "$idField");
   ...
   function add( $data ) {
      ...
      $this->db_songsplits_api_new->insert('writer_administrator', $data);
   ...
   function modify($keyvalue, $data) {
      ...
      $this->db_songsplits_api_new->where('wa_id', $keyvalue);
      $this->db_songsplits_api_new->update('writer_administrator', $data);
   ...
   function delete_by_pkey($idField) {
      ...
      // ///////////////////////////////////////////////////////////////////////
      // $this->db_songsplits_api_new->where('wa_id', $idField);
      // $this->db_songsplits_api_new->delete('writer_administrator');
