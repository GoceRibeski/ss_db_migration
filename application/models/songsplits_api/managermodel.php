...
//   }
   ...
   function find($filters = NULL, $start = NULL, $count = NULL) {
      ...
      // ///////////////////////////////////////////////////////////////////////
      $this->table_record_count = $this->db_songsplits_api->count_all( 'manager' );
      ...
      $query = $this->db_songsplits_api->get( 'manager' );
   ...
   function retrieve_by_pkey($idField) {
      ...
      $this->db_songsplits_api->where( 'attorney_id', "$idField");
   ...
   function add( $data ) {
      ...
      $this->db_songsplits_api->insert('manager', $data);
   ...
   function modify($keyvalue, $data) {
      ...
      $this->db_songsplits_api->where('attorney_id', $keyvalue);
      $this->db_songsplits_api->update('manager', $data);
   ...
   function delete_by_pkey($idField) {
      ...
      // ///////////////////////////////////////////////////////////////////////
      // $this->db_songsplits_api->where('attorney_id', $idField);
      // $this->db_songsplits_api->delete('manager');
