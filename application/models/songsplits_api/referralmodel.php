...
//   }
   ...
   function find($filters = NULL, $start = NULL, $count = NULL) {
      ...
      // ///////////////////////////////////////////////////////////////////////
      $this->table_record_count = $this->db_songsplits_api->count_all( 'referral' );
      ...
      $query = $this->db_songsplits_api->get( 'referral' );
   ...
   function retrieve_by_pkey($idField) {
      ...
      $this->db_songsplits_api->where( 'referral_id', "$idField");
   ...
   function add( $data ) {
      ...
      $this->db_songsplits_api->insert('referral', $data);
   ...
   function modify($keyvalue, $data) {
      ...
      $this->db_songsplits_api->where('referral_id', $keyvalue);
      $this->db_songsplits_api->update('referral', $data);
   ...
   function delete_by_pkey($idField) {
      ...
      // ///////////////////////////////////////////////////////////////////////
      // $this->db_songsplits_api->where('referral_id', $idField);
      // $this->db_songsplits_api->delete('referral');
