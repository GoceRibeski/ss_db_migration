...
class Request extends CI_Controller {
   ...
   */
   ...
   function browse() {
      ...
      $this->load->model('songsplits_api/requestmodel');                  // Instantiate the model
      ...
      $this->layout->render_page('/songsplits_api/request/requestgrid', $the_results);
      // NOTE: If you don't want to use the layout library, use the line below.
      // $this->load->view('songsplits_api/request/requestgrid', $the_results);
   ...
   function add() {
      ...
      if ( $submit != false ) {
         ...
         // ////////////////////////////////////////////////////////////////////
         $this->load->model('songsplits_api/requestmodel');
         ...
         */
         ...
         // $this->load->helper('url');
         redirect('/songsplits_api/request/', 'location');
         ...
         */
         ...
         $this->load->library('songsplits_api/layout');
         $this->layout->render_page('/songsplits_api/request/requestdetails', $data);
         // NOTE: If you don't want to use the layout library, use the line below.
         // $this->load->view('songsplits_api/request/requestdetails', $data);
