...
class Administrator extends CI_Controller {
   ...
   */
   ...
   function browse() {
      ...
      $this->load->model('songsplits_api/administratormodel');                  // Instantiate the model
      ...
      $this->layout->render_page('/songsplits_api/administrator/administratorgrid', $the_results);
      // NOTE: If you don't want to use the layout library, use the line below.
      // $this->load->view('songsplits_api/administrator/administratorgrid', $the_results);
   ...
   function add() {
      ...
      if ( $submit != false ) {
         ...
         // ////////////////////////////////////////////////////////////////////
         $this->load->model('songsplits_api/administratormodel');
         ...
         */
         ...
         // $this->load->helper('url');
         redirect('/songsplits_api/administrator/', 'location');
         ...
         */
         ...
         $this->load->library('songsplits_api/layout');
         $this->layout->render_page('/songsplits_api/administrator/administratordetails', $data);
         // NOTE: If you don't want to use the layout library, use the line below.
         // $this->load->view('songsplits_api/administrator/administratordetails', $data);
