...
//      return $this->find(array('connection_id' => '$key_value'));
//   }
   ...
   function find($filters = NULL, $start = NULL, $count = NULL) {
      ...
      // ///////////////////////////////////////////////////////////////////////
      $this->table_record_count = $this->db_songsplits_live->count_all( 'connection_rnm' );
      ...
      $query = $this->db_songsplits_live->get( 'connection_rnm' );
      ...
      if ($query->num_rows() > 0) {
         ...
         foreach ($query->result_array() as $row)      // Go through the result set
         {
			...
			$query_results['writer_id1']		 = $row['writer_id1'];
   ...
   function retrieve_by_pkey($idField) {
      ...
      $this->db_songsplits_live->where( 'connection_id', "$idField");
   ...
   function add( $data ) {
      ...
      $this->db_songsplits_live->insert('connection_rnm', $data);
   ...
   function modify($keyvalue, $data) {
      ...
      $this->db_songsplits_live->where('connection_id', $keyvalue);
      $this->db_songsplits_live->update('connection_rnm', $data);
   ...
   function delete_by_pkey($idField) {
      ...
      // ///////////////////////////////////////////////////////////////////////
      // $this->db_songsplits_live->where('connection_id', $idField);
      // $this->db_songsplits_live->delete('connection_rnm');
	...
	function get_Writer_id1() {
		return $this->writer_id1;	}

	function set_Writer_id1($writer_id1) {
		$this->writer_id1 = $writer_id1;	}
