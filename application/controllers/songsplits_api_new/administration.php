...
class Administration extends CI_Controller {
   ...
   */
   ...
   function browse() {
      ...
      $this->load->model('songsplits_api_new/administrationmodel');                  // Instantiate the model
      ...
      $this->layout->render_page('/songsplits_api_new/administration/administrationgrid', $the_results);
      // NOTE: If you don't want to use the layout library, use the line below.
      // $this->load->view('/songsplits_api_new/administration/administrationgrid', $the_results);
   ...
   function add() {
      ...
      if ( $submit != false ) {
         ...
         */
         ...
         // $this->load->helper('url');
         redirect('/songsplits_api_new/administration/', 'location');
         ...
         */
         ...
         $this->load->library('songsplits_api_new/layout');
         $this->layout->render_page('/songsplits_api_new/administration/administrationdetails', $data);
         // NOTE: If you don't want to use the layout library, use the line below.
         // $this->load->view('/songsplits_api_new/administration/administrationdetails', $data);
   ...
   function modify() {
      ...
      if ( $submit != false ) {
         ...
         */
         ...
         $this->administrationmodel->modify($data['id'], $data);
