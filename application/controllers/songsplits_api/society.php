...
class Society extends CI_Controller {
   ...
   */
   ...
   function browse() {
      ...
      $this->load->model('songsplits_api/societymodel');                  // Instantiate the model
      ...
      $this->layout->render_page('/songsplits_api/society/societygrid', $the_results);
      // NOTE: If you don't want to use the layout library, use the line below.
      // $this->load->view('songsplits_api/society/societygrid', $the_results);
   ...
   function add() {
      ...
      if ( $submit != false ) {
         ...
         // ////////////////////////////////////////////////////////////////////
         $this->load->model('songsplits_api/societymodel');
         ...
         */
         ...
         // $this->load->helper('url');
         redirect('/songsplits_api/society/', 'location');
         ...
         */
         ...
         $this->load->library('songsplits_api/layout');
         $this->layout->render_page('/songsplits_api/society/societydetails', $data);
         // NOTE: If you don't want to use the layout library, use the line below.
         // $this->load->view('songsplits_api/society/societydetails', $data);
