...
//   }
   ...
   function find($filters = NULL, $start = NULL, $count = NULL) {
      ...
      // ///////////////////////////////////////////////////////////////////////
      $this->table_record_count = $this->db_songsplits_api_new->count_all( 'social' );
      ...
      $query = $this->db_songsplits_api_new->get( 'social' );
   ...
   function retrieve_by_pkey($idField) {
      ...
      $this->db_songsplits_api_new->where( 'social_id', "$idField");
   ...
   function add( $data ) {
      ...
      $this->db_songsplits_api_new->insert('social', $data);
   ...
   function modify($keyvalue, $data) {
      ...
      $this->db_songsplits_api_new->where('social_id', $keyvalue);
      $this->db_songsplits_api_new->update('social', $data);
   ...
   function delete_by_pkey($idField) {
      ...
      // ///////////////////////////////////////////////////////////////////////
      // $this->db_songsplits_api_new->where('social_id', $idField);
      // $this->db_songsplits_api_new->delete('social');
