<?
   ...
   $modify_url = site_url('language/modify/');
   $delete_url = site_url('language/delete/');
   $add_url    = site_url('language/add/');
...
<form action='<?= $add_url; ?>' method='POST' id='frmlanguage'>
<table width="100%" border="0" cellspacing="1" cellpadding="0">
<tr>
   <th align="left" class="formSecHeader">Browsing language values</th>
   <th align="right">
...
<tbody  class="scrollingContent">
      ...
      <tr bgcolor="<?= $bgColor; ?>">
         <td align="center" nowrap="nowrap">
            <a href = "<?= $modify_url."/".$language["language_id"]; ?>" >Edit</a>
            &nbsp;&nbsp;&nbsp;
            <a href = "<?= $delete_url."/".$language["language_id"]; ?>" >Delete</a>
         </td>
   <td align="left" nowrap="nowrap"><?= $language['language_id']; ?></td>
   <td align="left" nowrap="nowrap"><?= $language['language_name']; ?></td>
</tr>
      <? } ?>
</tbody>
</table>
