<?
   ...
   $modify_url = site_url('user_group/modify/');
   $delete_url = site_url('user_group/delete/');
   $add_url    = site_url('user_group/add/');
...
<form action='<?= $add_url; ?>' method='POST' id='frmuser_group'>
<table width="100%" border="0" cellspacing="1" cellpadding="0">
<tr>
   <th align="left" class="formSecHeader">Browsing user_group values</th>
   <th align="right">
...
<tbody  class="scrollingContent">
      ...
      <tr bgcolor="<?= $bgColor; ?>">
         <td align="center" nowrap="nowrap">
            <a href = "<?= $modify_url."/".$user_group["gr_id"]; ?>" >Edit</a>
            &nbsp;&nbsp;&nbsp;
            <a href = "<?= $delete_url."/".$user_group["gr_id"]; ?>" >Delete</a>
         </td>
   <td align="left" nowrap="nowrap"><?= $user_group['gr_id']; ?></td>
   <td align="left" nowrap="nowrap"><?= $user_group['gr_name']; ?></td>
</tr>
      <? } ?>
</tbody>
</table>
