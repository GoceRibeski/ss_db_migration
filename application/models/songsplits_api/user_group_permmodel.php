...
//   }
   ...
   function find($filters = NULL, $start = NULL, $count = NULL) {
      ...
      // ///////////////////////////////////////////////////////////////////////
      $this->table_record_count = $this->db_songsplits_api->count_all( 'user_group_perm' );
      ...
      $query = $this->db_songsplits_api->get( 'user_group_perm' );
   ...
   function retrieve_by_pkey($idField) {
      ...
      $this->db_songsplits_api->where( 'per_id', "$idField");
   ...
   function add( $data ) {
      ...
      $this->db_songsplits_api->insert('user_group_perm', $data);
   ...
   function modify($keyvalue, $data) {
      ...
      $this->db_songsplits_api->where('per_id', $keyvalue);
      $this->db_songsplits_api->update('user_group_perm', $data);
   ...
   function delete_by_pkey($idField) {
      ...
      // ///////////////////////////////////////////////////////////////////////
      // $this->db_songsplits_api->where('per_id', $idField);
      // $this->db_songsplits_api->delete('user_group_perm');
