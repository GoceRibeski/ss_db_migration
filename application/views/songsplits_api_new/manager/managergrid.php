...
<tbody  class="scrollingContent">
      ...
      <tr bgcolor="<?= $bgColor; ?>">
         <td align="center" nowrap="nowrap">
            <a href = "<?= $modify_url."/".$manager["attorney_id"]; ?>" >Edit</a>
            &nbsp;&nbsp;&nbsp;
            <a href = "<?= $delete_url."/".$manager["attorney_id"]; ?>" >Delete</a>
         </td>
   <td align="left" nowrap="nowrap"><?= $manager['attorney_id']; ?></td>
   <td align="left" nowrap="nowrap"><?= $manager['company']; ?></td>
   <td align="left" nowrap="nowrap"><?= $manager['user_id']; ?></td>
</tr>
      <? } ?>
</tbody>
</table>
