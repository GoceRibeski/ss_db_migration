...
/**
 * MODULE NAME   : sessionmodel.php
 *
 * DESCRIPTION   : Session model controller
 *
 * MODIFICATION HISTORY
 *   V1.0   2016-06-16 05:13 PM   - Pradesh Chanderpaul     - Created
 *
 * @package             session
 * @subpackage          Session model component Class
...
//      return $this->find(array('session_id' => '$key_value'));
//   }
   ...
   function find($filters = NULL, $start = NULL, $count = NULL) {
      ...
      // ///////////////////////////////////////////////////////////////////////
      $this->table_record_count = $this->db_songsplits_api->count_all( 'session' );
      ...
      $query = $this->db_songsplits_api->get( 'session' );
      ...
      if ($query->num_rows() > 0) {
         ...
         foreach ($query->result_array() as $row)      // Go through the result set
         {
			...
			$query_results['expiry_date']		 = $row['expiry_date'];
			$query_results['session_id']		 = $row['session_id'];
			$query_results['token']		 = $row['token'];
   ...
   function retrieve_by_pkey($idField) {
      ...
      $this->db_songsplits_api->where( 'session_id', "$idField");
   ...
   function add( $data ) {
      ...
      $this->db_songsplits_api->insert('session', $data);
   ...
   function modify($keyvalue, $data) {
      ...
      $this->db_songsplits_api->where('session_id', $keyvalue);
      $this->db_songsplits_api->update('session', $data);
   ...
   function delete_by_pkey($idField) {
      ...
      // ///////////////////////////////////////////////////////////////////////
      // $this->db_songsplits_api->where('session_id', $idField);
      // $this->db_songsplits_api->delete('session');
