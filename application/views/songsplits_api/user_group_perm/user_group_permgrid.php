<?
   ...
   $modify_url = site_url('user_group_perm/modify/');
   $delete_url = site_url('user_group_perm/delete/');
   $add_url    = site_url('user_group_perm/add/');
...
<form action='<?= $add_url; ?>' method='POST' id='frmuser_group_perm'>
<table width="100%" border="0" cellspacing="1" cellpadding="0">
<tr>
   <th align="left" class="formSecHeader">Browsing user_group_perm values</th>
   <th align="right">
...
<tbody  class="scrollingContent">
      ...
      <?
         $i = 0;
         foreach ($user_group_perm_list as $user_group_perm) {
            $i++;
            if (($i%2)==0) { $bgColor = "#FFFFFF"; } else { $bgColor = "#C0C0C0"; }
      ?>
      <tr bgcolor="<?= $bgColor; ?>">
         <td align="center" nowrap="nowrap">
            <a href = "<?= $modify_url."/".$user_group_perm["per_id"]; ?>" >Edit</a>
            &nbsp;&nbsp;&nbsp;
            <a href = "<?= $delete_url."/".$user_group_perm["per_id"]; ?>" >Delete</a>
         </td>
   <td align="left" nowrap="nowrap"><?= $user_group_perm['per_id']; ?></td>
   <td align="left" nowrap="nowrap"><?= $user_group_perm['per_group_id']; ?></td>
   <td align="left" nowrap="nowrap"><?= $user_group_perm['per_flag']; ?></td>
</tr>
      <? } ?>
</tbody>
</table>
