<?
   ...
   $modify_url = site_url('trackemail/modify/');
   $delete_url = site_url('trackemail/delete/');
   $add_url    = site_url('trackemail/add/');
...
<form action='<?= $add_url; ?>' method='POST' id='frmtrackemail'>
<table width="100%" border="0" cellspacing="1" cellpadding="0">
<tr>
   <th align="left" class="formSecHeader">Browsing trackemail values</th>
   <th align="right">
...
<tbody  class="scrollingContent">
      ...
      <?
         $i = 0;
         foreach ($trackemail_list as $trackemail) {
            $i++;
            if (($i%2)==0) { $bgColor = "#FFFFFF"; } else { $bgColor = "#C0C0C0"; }
      ?>
      <tr bgcolor="<?= $bgColor; ?>">
         <td align="center" nowrap="nowrap">
            <a href = "<?= $modify_url."/".$trackemail["track_id"]; ?>" >Edit</a>
            &nbsp;&nbsp;&nbsp;
            <a href = "<?= $delete_url."/".$trackemail["track_id"]; ?>" >Delete</a>
         </td>
   <td align="left" nowrap="nowrap"><?= $trackemail['track_id']; ?></td>
   <td align="left" nowrap="nowrap"><?= $trackemail['writer_id']; ?></td>
   <td align="left" nowrap="nowrap"><?= $trackemail['new_writer_id']; ?></td>
   <td align="left" nowrap="nowrap"><?= $trackemail['email']; ?></td>
   <td align="left" nowrap="nowrap"><?= $trackemail['date_added']; ?></td>
</tr>
      <? } ?>
</tbody>
</table>
