<?
   ...
   $modify_url = site_url('other/modify/');
   $delete_url = site_url('other/delete/');
   $add_url    = site_url('other/add/');
...
<form action='<?= $add_url; ?>' method='POST' id='frmother'>
<table width="100%" border="0" cellspacing="1" cellpadding="0">
<tr>
   <th align="left" class="formSecHeader">Browsing other values</th>
   <th align="right">
...
<tbody  class="scrollingContent">
      ...
      <tr bgcolor="<?= $bgColor; ?>">
         <td align="center" nowrap="nowrap">
            <a href = "<?= $modify_url."/".$other["other_id"]; ?>" >Edit</a>
            &nbsp;&nbsp;&nbsp;
            <a href = "<?= $delete_url."/".$other["other_id"]; ?>" >Delete</a>
         </td>
   <td align="left" nowrap="nowrap"><?= $other['other_id']; ?></td>
   <td align="left" nowrap="nowrap"><?= $other['user_id']; ?></td>
   <td align="left" nowrap="nowrap"><?= $other['company']; ?></td>
</tr>
      <? } ?>
</tbody>
</table>
