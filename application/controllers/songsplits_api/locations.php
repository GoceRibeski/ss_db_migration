...
class Locations extends CI_Controller {
   ...
   */
   ...
   function browse() {
      ...
      $this->load->model('songsplits_api/locationsmodel');                  // Instantiate the model
      ...
      $this->layout->render_page('/songsplits_api/locations/locationsgrid', $the_results);
      // NOTE: If you don't want to use the layout library, use the line below.
      // $this->load->view('songsplits_api/locations/locationsgrid', $the_results);
   ...
   function add() {
      ...
      if ( $submit != false ) {
         ...
         // ////////////////////////////////////////////////////////////////////
         $this->load->model('songsplits_api/locationsmodel');
         ...
         */
         ...
         // $this->load->helper('url');
         redirect('/songsplits_api/locations/', 'location');
         ...
         */
         ...
         $this->load->library('songsplits_api/layout');
         $this->layout->render_page('/songsplits_api/locations/locationsdetails', $data);
         // NOTE: If you don't want to use the layout library, use the line below.
         // $this->load->view('songsplits_api/locations/locationsdetails', $data);
