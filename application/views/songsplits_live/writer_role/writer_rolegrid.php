<?
   ...
   $modify_url = site_url('writer_role/modify/');
   $delete_url = site_url('writer_role/delete/');
   $add_url    = site_url('writer_role/add/');
...
<form action='<?= $add_url; ?>' method='POST' id='frmwriter_role'>
<table width="100%" border="0" cellspacing="1" cellpadding="0">
<tr>
   <th align="left" class="formSecHeader">Browsing writer_role values</th>
   <th align="right">
...
<tbody  class="scrollingContent">
      ...
      <?
         $i = 0;
         foreach ($writer_role_list as $writer_role) {
            $i++;
            if (($i%2)==0) { $bgColor = "#FFFFFF"; } else { $bgColor = "#C0C0C0"; }
      ?>
      <tr bgcolor="<?= $bgColor; ?>">
         <td align="center" nowrap="nowrap">
            <a href = "<?= $modify_url."/".$writer_role["role_id"]; ?>" >Edit</a>
            &nbsp;&nbsp;&nbsp;
            <a href = "<?= $delete_url."/".$writer_role["role_id"]; ?>" >Delete</a>
         </td>
   <td align="left" nowrap="nowrap"><?= $writer_role['role_id']; ?></td>
   <td align="left" nowrap="nowrap"><?= $writer_role['role_name']; ?></td>
   <td align="left" nowrap="nowrap"><?= $writer_role['shortcode']; ?></td>
</tr>
      <? } ?>
</tbody>
</table>
