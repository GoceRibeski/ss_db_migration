...
<tbody  class="scrollingContent">
      ...
      <tr bgcolor="<?= $bgColor; ?>">
         <td align="center" nowrap="nowrap">
            <a href = "<?= $modify_url."/".$session["id"]; ?>" >Edit</a>
            &nbsp;&nbsp;&nbsp;
            <a href = "<?= $delete_url."/".$session["id"]; ?>" >Delete</a>
         </td>
   <td align="left" nowrap="nowrap"><?= $session['id']; ?></td>
   <td align="left" nowrap="nowrap"><?= $session['user_id']; ?></td>
   <td align="left" nowrap="nowrap"><?= $session['is_admin']; ?></td>
