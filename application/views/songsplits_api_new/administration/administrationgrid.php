...
<tbody  class="scrollingContent">
      ...
      <tr bgcolor="<?= $bgColor; ?>">
         <td align="center" nowrap="nowrap">
            <a href = "<?= $modify_url."/".$administration["id"]; ?>" >Edit</a>
            &nbsp;&nbsp;&nbsp;
            <a href = "<?= $delete_url."/".$administration["id"]; ?>" >Delete</a>
         </td>
   <td align="left" nowrap="nowrap"><?= $administration['access']; ?></td>
   <td align="left" nowrap="nowrap"><?= $administration['administrator_id']; ?></td>
   <td align="left" nowrap="nowrap"><?= $administration['deal_type']; ?></td>
   <td align="left" nowrap="nowrap"><?= $administration['id']; ?></td>
   <td align="left" nowrap="nowrap"><?= $administration['publisher_id']; ?></td>
</tr>
      <? } ?>
</tbody>
</table>
