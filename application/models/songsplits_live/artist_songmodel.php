<?php
class Artist_songModel extends CI_Model {
/**
 * MODULE NAME   : artist_songmodel.php
 *
 * DESCRIPTION   : Artist_song model controller
 *
 * MODIFICATION HISTORY
 *   V1.0   2016-06-16 05:21 PM   - Pradesh Chanderpaul     - Created
 *
 * @package             artist_song
 * @subpackage          Artist_song model component Class
...
//      return $this->find(array('artist_song_id' => '$key_value'));
//   }
   ...
   function find($filters = NULL, $start = NULL, $count = NULL) {
      ...
      // ///////////////////////////////////////////////////////////////////////
      $this->table_record_count = $this->db_songsplits_live->count_all( 'artist_song' );
      ...
      $query = $this->db_songsplits_live->get( 'artist_song' );
      ...
      if ($query->num_rows() > 0) {
         ...
         foreach ($query->result_array() as $row)      // Go through the result set
         {
			...
			$query_results['artist_song_id']		 = $row['artist_song_id'];
   ...
   function retrieve_by_pkey($idField) {
      ...
      $this->db_songsplits_live->where( 'artist_song_id', "$idField");
   ...
   function add( $data ) {
      ...
      $this->db_songsplits_live->insert('artist_song', $data);
   ...
   function modify($keyvalue, $data) {
      ...
      $this->db_songsplits_live->where('artist_song_id', $keyvalue);
      $this->db_songsplits_live->update('artist_song', $data);
   ...
   function delete_by_pkey($idField) {
      ...
      // ///////////////////////////////////////////////////////////////////////
      // $this->db_songsplits_live->where('artist_song_id', $idField);
      // $this->db_songsplits_live->delete('artist_song');
	...
	function get_Artist_song_id() {
		return $this->artist_song_id;	}

	function set_Artist_song_id($artist_song_id) {
		$this->artist_song_id = $artist_song_id;	}
